...
ActiveRecord::Schema.define(version: 2021_03_18_005154) do
  ...
  create_table "reservas", force: :cascade do |t|
    ...
    t.index ["veiculos_id"], name: "index_reservas_on_veiculos_id"
  end
  ...
  add_foreign_key "reservas", "veiculos", column: "veiculos_id"
